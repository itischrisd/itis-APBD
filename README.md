...
Repository that contains solutions to the exercises for the APBD (Database Applications) practical classes, taught by
Jakub Biniek during studies on [PJAIT](https://www.pja.edu.pl/en/).
...
repository [here](https://github.com/itischrisd/IncomeApp).
