...
public static class LinqTasks
{
    ...
    private static IEnumerable<Emp> Emps { get; }
    private static IEnumerable<Dept> Depts { get; }
    ...
    {
        var result = Emps.Where(e => e.Salary == Emps.Max(e2 => e2.Salary));
        return result;
    }
    ...
    public static IEnumerable<object> Task11()
    {
        IEnumerable<object> result = Emps.GroupBy(e => e.Deptno)
            ...
            .Select(g => new
            {
                name = Depts.First(d => d.Deptno == g.Key)
                    .Dname.ToUpper(),
    ...
    /// </summary>
    public static int Task13(IEnumerable<int> arr)
    {
    ...
    public static IEnumerable<Dept> Task14()
    {
        var result = Emps.GroupBy(e => e.Deptno)
            ...
            .OrderBy(g => g.Key)
            .Select(g => Depts.First(d => d.Deptno == g.Key));
        return result;
    }
    ...
    {
        //all combinations off emp, dpet pairs
        var result = Emps.SelectMany(e => Depts, (e, d) => new { e, d });
        return result.Select(x => x.d);
    }
}
...
public static class CustomExtensionMethods
{
    ...
    {
        var enumerable = emps.ToList();
        var result = enumerable.Where(e => enumerable.Any(e2 => e2.Mgr == e.Mgr))
            .OrderBy(e => e.Ename)
